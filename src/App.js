    ...
    <div className="App">
      <Router>
        ...
        <Routes>
          ...
          <Route
            path="/explore"
            element={<Explore mode={mode} toggleMode={toggleMode} />}
          />
          <Route
            path="/exploreinsidepage"
            element={<Exploreinsidepage mode={mode} toggleMode={toggleMode} />}
          />
          <Route
            path="/collectionsstate"
            element={<Collectionsstate mode={mode} toggleMode={toggleMode} />}
          />
          <Route
            path="/resourceshelpcenter"
            element={
              <ResourcesHelpCenter mode={mode} toggleMode={toggleMode} />
            }
          />
          <Route
            path="/resourcesnewsletter"
            element={
              <ResourcesNewsletter mode={mode} toggleMode={toggleMode} />
            }
          />
          <Route
            path="/profile"
          ...
          <Route
            path="/profilesetting"
            element={<ProfileSetting mode={mode} toggleMode={toggleMode} />}
          />
          <Route
            path="/notifications"
            element={<Notificationspage mode={mode} toggleMode={toggleMode} />}
          />
          <Route path="/offers" element={<Offers />} />
          <Route
            path="/featureditems"
            element={<Featureditems mode={mode} toggleMode={toggleMode} />}
          />
          <Route
            path="/accountsupport"
            element={<AccountSupport mode={mode} toggleMode={toggleMode} />}
          />
          <Route
            path="/earnings"
            element={<Earnings mode={mode} toggleMode={toggleMode} />}
          />
          <Route
            path="/collectioninsidepage"
            element={
              <Collectioninsidepage mode={mode} toggleMode={toggleMode} />
            }
          />
        </Routes>
      </Router>
